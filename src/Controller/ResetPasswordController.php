...
class ResetPasswordController extends AbstractController
{
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, TransportInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $templateContent = $this->renderView('reset_password/email.html.twig', [
            'subject' => 'Test Email with Twig HTML',
            'resetToken' => $resetToken,
        ]);
        $email = (new Email())
        ->from('eseht.xila@gmail.com')
        ->to($user->getEmail())
        //->cc('cc@example.com')
        //->bcc('bcc@example.com')
        ...
        ->text('Changement de votre mot de passe')
        ...
        //     ->from(new Address('eseht.xila@gmail.com', 'Administrateur'))
        //     ->to($user->getEmail())
